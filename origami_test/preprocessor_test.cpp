...
TEST_F(PreprocessorsTest, Include)
{
  ...
  ASSERT_TRUE(equalTokens("# include", { { Token::KeywordPreprocessor, "#include" } }));

  ASSERT_TRUE(equalTokens("# include ", { { Token::KeywordPreprocessor, "#include" } }));

  ASSERT_TRUE(equalTokens("# + include", { { Token::Punctuator, "#" }, { Token::Operator, "+" }, { Token::Identifier, "include" } }));

  ASSERT_TRUE(equalTokens("# include <memory>", { { Token::KeywordPreprocessor, "#include" }, { Token::Literal, "<memory>" } }));

  ASSERT_TRUE(equalTokens("# include \"memory\"", { { Token::KeywordPreprocessor, "#include" }, { Token::Literal, "\"memory\"" } }));

  ASSERT_TRUE(equalTokens("# + include \"memory\"",
    { { Token::Punctuator, "#" }, { Token::Operator, "+" }, { Token::Identifier, "include" }, { Token::Literal, "\"memory\"" } }));

  ASSERT_TRUE(equalTokens(
    "# include + \"memory\"", { { Token::KeywordPreprocessor, "#include" }, { Token::Operator, "+" }, { Token::Literal, "\"memory\"" } }));

  ASSERT_TRUE(equalTokens("# include int \"memory\"",
    { { Token::KeywordPreprocessor, "#include" }, { Token::Keyword, "int" }, { Token::Literal, "\"memory\"" } }));

  ASSERT_TRUE(equalTokens("# include 0.0123 \"memory\"",
    { { Token::KeywordPreprocessor, "#include" }, { Token::Literal, "0.0123" }, { Token::Literal, "\"memory\"" } }));
  ...
  ASSERT_TRUE(equalTokens("# icustomdefine", { { Token::Punctuator, "#" }, { Token::Identifier, "icustomdefine" } }));
  ...
  ASSERT_TRUE(equalTokens("# includecustomdefine", { { Token::Punctuator, "#" }, { Token::Identifier, "includecustomdefine" } }));

  ASSERT_TRUE(equalTokens("# include customdefine", { { Token::KeywordPreprocessor, "#include" }, { Token::Identifier, "customdefine" } }));

  ASSERT_TRUE(equalTokens("# include \"customdefine",
    { { Token::KeywordPreprocessor, "#include" }, { Token::Punctuator, "\"" }, { Token::Identifier, "customdefine" } }));
}
